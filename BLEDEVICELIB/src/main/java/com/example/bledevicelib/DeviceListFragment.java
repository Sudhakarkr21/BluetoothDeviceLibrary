...
public class DeviceListFragment extends DialogFragment {
    ...
    private PrinterInfo.OnConnectPrinter onConnectPrinter;
    ...
    public void setOnConnectPrinter(PrinterInfo.OnConnectPrinter onConnectPrinter) {
    ...
    /*private void testPrinter() {
        PrinterInfo.with(getActivity(), mPrinterName).printTest();
    }*/
